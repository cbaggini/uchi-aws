        ...
        <AppBar className={classes.appBar}>
          <Toolbar>
            <Typography variant="h5" className={classes.title}>
              Please read the Disclaimer, check the box and fill out the form
              below
            </Typography>
            <IconButton
        ...
        <List className={`${classes.form} upload-modal`}>
          <ListItem className={classes.disclaimer}>
            ...
            <Typography variant="h6" className={classes.disclaimer}>
              We welcome your contribution to this site. Your safety and
              wellbeing are our priorities. Personal data and information you
              upload to this site will be processed according to UK data
              protection law. It will also be in the public domain for everyone
              to see. Please therefore do not upload your full postcode or other
              information which may precisely identify your location. Do not use
              your full name and limit other identifying information where
              possible. We moderate content uploaded to the site. We may edit
              information published at our absolute discretion.
            </Typography>
            <Typography>
              <FormControlLabel
                control={
